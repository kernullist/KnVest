...
fn create_vm_interpreter_stub(_image_base: u64, _section_rva: u32) -> (Vec<u8>, usize) {
    ...
    stub.extend_from_slice(&[
        0x48, 0x8B, 0x43, 0x3C,
        0x8B, 0x84, 0x18, 0x88, 0x00, 0x00, 0x00,
        0x48, 0x01, 0xD8,
        0x8B, 0x78, 0x20,
        0x48, 0x01, 0xDF,
        0x8B, 0x48, 0x24,
    ...
    stub.extend_from_slice(&[
        0x48, 0x8D, 0x0D, 0x8B, 0x00, 0x00, 0x00,
        0x48, 0x89, 0xCA,
        0x48, 0x83, 0xEC, 0x20,
        0xFF, 0x55, 0x80,
        0x48, 0x83, 0xC4, 0x20,
    ...
    stub.extend_from_slice(&[
        0x48, 0x8D, 0x35, 0x7E, 0x00, 0x00, 0x00,
    ]);
    ...
    stub.extend_from_slice(&[
        ...
        0x48, 0x83, 0xEC, 0x30,
        0x48, 0x8B, 0x4D, 0x98,
        0x48, 0x8D, 0x15, 0x24, 0x00, 0x00, 0x00,
        0x48, 0x8B, 0x45, 0xC8,
        0x48, 0x01, 0xD0,
        0x48, 0x89, 0xC2,
        0x48, 0x8B, 0x45, 0xD0,
    ...
    stub.extend_from_slice(b"GetStdHandle\0WriteFile\0");
